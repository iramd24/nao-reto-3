//function that returns an adjacency list given number of vertices V and an array of edges E
...
//function that executes dijkstra's algorithm and returns an array of costs given an adjacency list graph, the number of vertices V and the source node src
